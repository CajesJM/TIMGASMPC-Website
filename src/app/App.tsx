...
import { PublicLayout } from "@/layouts/user/PublicLayout/PublicLayout";
...
const ManagerLayout = lazy(() =>
  import("@/components/admin/layout/ManagerLayout/ManagerLayout").then((module) => ({
    default: module.ManagerLayout,
  })),
);
const ProtectedManagerRoute = lazy(() =>
  import("@/components/admin/auth/ProtectedManagerRoute/ProtectedManagerRoute").then(
    (module) => ({
